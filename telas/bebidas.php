...
<div class="container-fluid">
  ...
  <div class="row titulo_bebidas">
    <div class="col-12">
      <h1 class="titulo3">Bebidas</h1>
    </div>
  </div>

  <div id="tit1" class="row titulo_bebida">
    <div class="col-12">
      <h1 id="artezanais" class="titulo2">Artezanais</h1>
    </div>
  </div>

<div class="fundochopps row">
<div class="col-12">

<div class="row fotos1">
  <div class="column">
    <div class="hovereffect">
      <img src="imagens/bebidas/chopps.jpg" style="width:100%" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
        <div class="overlay">
           <h1>Chopps Artezanais</h1>
        </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="hovereffect">
    <img src="imagens/bebidas/lovelena.jpg" style="width:100%" onclick="openModal();currentSlide(2)" class="hover-shadow cursor">
    <div class="overlay">
       <h1>Lovelena</h1>
    </div>
</div>
  ...
  <div class="column">
    <div class="hovereffect">
    <img src="imagens/bebidas/Caipirinha.jpg" style="width:100%" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
    <div class="overlay">
       <h1>Dose</h1>
    </div>
    </div>
  ...
  <div class="column">
    <div class="hovereffect">
    <img src="imagens/bebidas/regua.jpg" style="width:100%" onclick="openModal();currentSlide(4)" class="hover-shadow cursor">
    <div class="overlay">
       <h1>Régua de degustação</h1>
    </div>
  </div>
  </div>
  ...
  <div class="column">
    <div class="hovereffect">
    <img src="imagens/bebidas/suco.jpg" style="width:100%" onclick="openModal();currentSlide(5)" class="hover-shadow cursor">
    <div class="overlay">
  ...
  <div class="column">
    <div class="hovereffect">
    <img src="imagens/bebidas/agua.jpg" style="width:100%" onclick="openModal();currentSlide(6)" class="hover-shadow cursor">
    <div class="overlay">
       <h1>Água</h1>
    </div>
  </div>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="mySlides">
      ...
      <img src="imagens/bebidas/chopps.jpg" style="width:100%">
      <div align="center">
      <h1>Chopps Artezanais</h1>
      <h5>(Lovelena - Frida - Celebration - Cabra Macho)</h5>
    </div>
    </div>

    <div class="mySlides">
      <div class="numbertext">2 / 6</div>
      <img src="imagens/bebidas/lovelena.jpg" style="width:100%">
      <div align="center">
      <h1>Lovelena - Pilsen (300ml)</h1>
      <h5>Criada para ser servida no aniversário de Helena, essa é uma receita leve, refrescante e ideal para ser apreciada em dias quentes.
      <br>No paladar é possível sentir as notas de cereais maltados e no aroma todo o frescor do lúpulo. Harmoniza com tábuas de queijos e frios,
       petiscos e, especialmente iscas de tilápia.</h5>
     </div>
    </div>

    <div class="mySlides">
      <div class="numbertext">3 / 6</div>
      <img src="imagens/bebidas/Caipirinha.jpg" style="width:100%">
      <div align="center">
      <h1>Dose</h1>
    </div>
    </div>
    ...
    <div class="mySlides">
      ...
      <img src="imagens/bebidas/regua.jpg" style="width:100%">
      <div align="center">
      <h1>Régua de Degustação</h1>
    </div>
    </div>
    ...
    <div class="mySlides">
      ...
      <img src="imagens/bebidas/suco.jpg" style="width:100%">
      <div align="center">
      <h1>Suco de laranja natural - Copo (300ml)</h1>
    </div>
    </div>

    <div class="mySlides">
      <div class="numbertext">6 / 6</div>
      <img src="imagens/bebidas/agua.jpg" style="width:100%">
      <div align="center">
      <h1>Água</h1>
      <h4>(Com gás, sem gás ou tônica)</h4>
    </div>
    </div>
...
<div id="tit1" class="row titulo_bebida">
  <div class="col-12">
    <h1 id="convidados" class="titulo2">Convidados</h1>
  </div>
</div>
...
<div id="carouselExampleFade1" class="carousel slide carousel-fade" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <img class="d-block w-100" src="imagens/convidado1.jpg" alt="Primeiro Slide">
      <div align="center" class="carousel-caption d-none d-md-block">
        <h1 class="legenda-slide">Chopp 1</h1>
      </div>
    </div>

    <div class="carousel-item">
      <img class="d-block w-100" src="imagens/convidado2.jpg" alt="Segundo Slide">
      <div class="carousel-caption d-none d-md-block">
        <h1 class="legenda-slide">Chopp 2</h1>
      </div>
    </div>
  </div>
...
<div class="row rodape">
  ...
  <div class="col-md-10 col-sm-12">
    ...
    <div class="row">
      <div class="col-lg-3 col-md-12 col-sm-12">
        <p>
          <a href="#artezanais">Artezanais</a>
        </p>
      </div>
      <div class="col-lg-3 col-md-12 col-sm-12">
        <p>
